...
<Layout>
    <main class="landing-page px-4">
		...
		<p class="text-2xl sm:text-3xl md:text-4xl mt-12">
			<span class="highlighted-text">{data.contactInfo.title.split(" ")[0]}</span>{data.contactInfo.title
				.split(" ")
				.slice(1)
				.join(" ")}
		</p>
